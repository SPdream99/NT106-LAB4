...
namespace Lab04_Bai06
{
    public partial class Info : Form
    {
        ...
        public Info(string tokenType, string accessToken)
        {
            ...
            Load += (s, e) => infoGet(tokenType, accessToken);
        }

        // Xem như đây là một cli app, khi mà nhận được token thì bật form kết quả lên

        private async void infoGet(string tokenType, string accessToken)
        {
            ...
            var data = JObject.Parse(getUserResponseString);
            //string email = "";
            //string name = "";
            //string phone = "";
